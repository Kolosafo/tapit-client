...
const Socials = () => {
  ...
  const { socialLinks } = useSelector((store: IRootState) => store.data);

  const [socialEditor, setSocialEditor] = useState<string[]>([]);
    ...
    <div>
      <div className="p-4 bg-gray-100 rounded">
        <p className="font-semibold">
          Add social media accounts to your profile
        </p>
        <p className="text-xs">
          Click on the icon and type in your{" "}
          <span className="font-bold">username</span>{" "}
        </p>
        <div className="flex items-center w-full pt-5 space-x-5 overflow-scroll no-scrollbar">
          <span
            ...
            // rel="noreferrer"
            onClick={() =>
              setSocialEditor((initial) => [...initial, "twitter"])
            }
          >
            <svg
          ...
          <span
            ...
            // rel="noreferrer"
            onClick={() =>
              setSocialEditor((initial) => [...initial, "facebook"])
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span
            ...
            // target="_blank"
            // rel="noreferrer"
            onClick={() => setSocialEditor((initial) => [...initial, "github"])}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <span
            ...
            // rel="noreferrer"
            onClick={() =>
              setSocialEditor((initial) => [...initial, "linkedIn"])
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span
            ...
            // rel="noreferrer"
            onClick={() =>
              setSocialEditor((initial) => [...initial, "instagram"])
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span
            ...
            // target="_blank"
            // rel="noreferrer"
            onClick={() => setSocialEditor((initial) => [...initial, "redit"])}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <span
            ...
            // rel="noreferrer"
            onClick={() =>
              setSocialEditor((initial) => [...initial, "snapchat"])
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span
            ...
            // target="_blank"
            // rel="noreferrer"
            onClick={() => setSocialEditor((initial) => [...initial, "tiktok"])}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <span
            ...
            // rel="noreferrer"
            onClick={() =>
              setSocialEditor((initial) => [...initial, "telegram"])
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span
            ...
            // rel="noreferrer"
            onClick={() =>
              setSocialEditor((initial) => [...initial, "youtube"])
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span
            ...
            // rel="noreferrer"
            onClick={() =>
              setSocialEditor((initial) => [...initial, "whatsapp"])
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <span
            ...
            // href={
            //   socialLinks.length > 0 ? `${socialLinks[0].apple_music}` : "#"
            // }
            // target="_blank"
            // rel="noreferrer"
            onClick={() =>
              setSocialEditor((initial) => [...initial, "apple music"])
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      {socialLinks.length > 0 &&
        socialEditor.map((link: any) => {
          return (
            <div key={link}>
              {link === "instagram" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"instagram"}
                  url={socialLinks[0].instagram ? socialLinks[0].instagram : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "facebook" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"facebook"}
                  url={socialLinks[0].facebook ? socialLinks[0].facebook : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "twitter" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"twitter"}
                  url={socialLinks[0].twitter ? socialLinks[0].twitter : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "snapchat" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"snapchat"}
                  url={socialLinks[0].snapchat ? socialLinks[0].snapchat : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "github" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"github"}
                  url={socialLinks[0].github ? socialLinks[0].github : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "tiktok" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"tiktok"}
                  url={socialLinks[0].tiktok ? socialLinks[0].tiktok : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "whatsapp" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"whatsapp"}
                  url={socialLinks[0].whatsapp ? socialLinks[0].whatsapp : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "apple music" ? (
                <SocialCard
                  ...
                  title={"apple music"}
                  url={
                    socialLinks[0].apple_music ? socialLinks[0].apple_music : ""
                  }
                  id={socialLinks[0].id}
                />
              ) : link === "youtube" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"youtube"}
                  url={socialLinks[0].youtube ? socialLinks[0].youtube : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "telegram" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"telegram"}
                  url={socialLinks[0].telegram ? socialLinks[0].telegram : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "redit" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"redit"}
                  url={socialLinks[0].redit ? socialLinks[0].redit : ""}
                  id={socialLinks[0].id}
                />
              ) : link === "linkedIn" ? (
                <SocialCard
                  setVisible={setSocialEditor}
                  title={"linkedIn"}
                  url={socialLinks[0].linkedIn ? socialLinks[0].linkedIn : ""}
                  id={socialLinks[0].id}
                />
              ) : null}
            </div>
